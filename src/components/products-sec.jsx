  ...
  return (
    <div className="container landing-about-marg">
      ...
      <div className="row mt-3">
        <div className="col-md-5 mx-auto p-2" data-aos="fade-down-right">
            ...
            <div className="col-md-9">
              <div className="card">
                <div className="card-body">
                  <p className="h6 text-branding p-3">Verification Services</p>
                  <p className="">
        ...
        <div className="col-md-5 mx-auto p-2" data-aos="fade-down-left">
          <div className="row shadow">
            ...
            <div className="col-md-9">
              ...
              <p className="">
                Do you need to buy your choice property at your choice location,
                or you just need property services like Survey, Valuation,
                Documentation, Sourcing, Negotiation, Payment . . . then engage
                this Service at 100% done for you. This service caters for both
                individuals, corporate organizations, within Nigeria and in
                Diaspora.
              </p>
            </div>
            <div className="col-md-1"></div>
      ...
      <div className="row" style={{ paddingTop: "50px" }}>
        <div className="col-md-3 mx-auto p-3" style={{ paddingTop: "2rem" }}>
          <button
