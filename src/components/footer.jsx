      ...
      <div className="row">
        ...
        <div className="col-12">
          <p style={{ color: "lightgrey" }}>
            The foremost online property verification and Real Estate investment
            company that helps clients to acquire verified properties and invest
            in verified deals.
          </p>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <div className="row">
        <div className="col-12">
          <ul className="ul" style={{ listStyle: "none" }}>
            <li className="footerfancysideborder">Privacy policy</li>
            <li className="footerfancysideborder">Terms and Conditions</li>
          </ul>
        </div>
      </div>
    </>
